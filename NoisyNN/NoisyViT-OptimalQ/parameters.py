...
parser.add_argument('--model_saved_path', type=str, default='/content/drive/MyDrive/NoisyNN-main/NoisyNN-main/NoisyViT-OptimalQ/vit_models/50_384/large/')
# editted here
parser.add_argument('--imagenet_path', type=str, default='/content/drive/MyDrive/datasets/BUSI-Fold1/')
...
parser.add_argument('--noise_type', default='linear', type=str, help='gaussian, linear, impulse')
