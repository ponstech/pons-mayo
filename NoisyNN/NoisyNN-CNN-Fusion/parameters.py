...
parser.add_argument('--noisy_layer', default= 4, type = int, help='which layer to add noise, [1, 4]')
...
parser.add_argument('--class_num', default= 2, type = int, help='class numbers')
parser.add_argument('--datasets', default= 'BreastCancer', type = str, help='what dataset to use')
...
parser.add_argument('--breast_dataset_path', default= '/content/drive/MyDrive/NoisyNN-Breast/combined-breast-3fold', type = str, help='breast cancer dataset path')
parser.add_argument('--fold', default= 1, type = int, help='which fold to use (1, 2, or 3)')
parser.add_argument('--fusion_type', default= 'mid', type = str, help='fusion type: mid,early or late')
parser.add_argument('--gpu_id', default= '0', type = str, help='select gpus')
#ResNet18 [2,2,2,2]
#ResNet34 [3,4,6,3]
#ResNet50 [3,4,6,3]
#ResNet101 [3,4,23,3]
