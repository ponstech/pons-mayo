...
parser.add_argument('--scale', default='tiny', type = str,
                        help="model scale")
parser.add_argument('--datasets', default='BreastCancer', type = str,
                        help="choose dataset to experiment, ImageNet, TinyImageNet, Cifar100, Cifar10, BreastCancer")
parser.add_argument('--num_classes', default=2, type = int,
                        help="number of class categories")
parser.add_argument('--breast_dataset_path', default='../combined-breast-3fold', type=str, help='breast cancer dataset path')
parser.add_argument('--fold', default=1, type=int, help='which fold to use (1, 2, or 3)')
parser.add_argument('--fusion_type', default='mid', type=str, help='fusion type: mid or late')
