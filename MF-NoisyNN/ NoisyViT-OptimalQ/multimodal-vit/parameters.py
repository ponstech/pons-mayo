...
parser.add_argument('--model_saved_path', type=str, default='/content/drive/MyDrive/NoisyViT-OptimalQ/saved_models/output/Multimodal/ViT-B/')
parser.add_argument('--imagenet_path', type=str, default='/content/drive/MyDrive/dataset/data/data_split/bmode/')
...
parser.add_argument('--scale', default='tiny', type = str,
                        help="model scale")
parser.add_argument('--datasets', default='MultiModal', type = str,
                        help="choose dataset to experiment, ImageNet, TinyImageNet, Cifar100, Cifar10, MultiModal")
...
parser.add_argument('--bmode_path', type=str, default='/content/drive/MyDrive/dataset/bmode/', help='bmode modality root')
parser.add_argument('--enhanced_path', type=str, default='/content/drive/MyDrive/dataset/enhancement/', help='enhanced modality root')
parser.add_argument('--improved_path', type=str, default='/content/drive/MyDrive/dataset/improvement/', help='improved modality root')
