...
class AUDataLoader:
    ...
    def get_data_loaders(self):
        ...
        train_dataset = CLASS(os.path.join(csv_path, "mertfold3_train.csv"), 
                                 self.modalities,
                                 self.texture_root, 
                                 self.depth_root,
                                 self.thermal_root,
                                 self.transform_train)
        validate_dataset = CLASS(os.path.join(csv_path, "mertfold3_val.csv"),
                                 self.modalities,
                                 self.texture_root, 
                                 self.depth_root,
                                 self.thermal_root,
                                 self.transform_val)
        test_dataset = CLASS(os.path.join(csv_path, "mertfold3_test.csv"),
                                 self.modalities,
                                 self.texture_root, 
                                 self.depth_root,
                                 self.thermal_root,
